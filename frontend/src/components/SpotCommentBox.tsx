        ...
        <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-2">
          {threads.map(({ comment }) => (
            <button
              ...
              className="aspect-[3/2] min-w-0 overflow-hidden rounded-2xl bg-surface p-4 text-left focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal"
            >
