...
export default function MobileSearchTrigger({
  ...
  return (
    <button
      ...
      className={`flex min-h-11 w-full items-center justify-center gap-2.5 rounded-[14px] border border-line bg-surface text-ink shadow-float transition-transform active:scale-[0.99] focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink ${compact ? "px-4 py-2.5" : "px-6 py-4"}`}
    >
