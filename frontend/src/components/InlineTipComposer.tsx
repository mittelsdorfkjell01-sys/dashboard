  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <textarea
        ...
        className="min-h-[110px] w-full flex-1 resize-none rounded-2xl border border-line bg-white p-4 text-body text-ink placeholder:text-muted focus:border-teal/40 focus:outline-none focus:ring-2 focus:ring-teal/20"
      />
      ...
      <div className="mt-3 flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-full bg-teal/50 px-5 py-2 text-label font-medium text-white transition-colors hover:bg-teal/70 disabled:opacity-40"
        >
