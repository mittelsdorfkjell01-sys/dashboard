    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      {!parentId && !compact && (
        <div className="mb-3">
          ...
          <input id="inline-comment-title" value={title} maxLength={120} onChange={(e) => setTitle(e.target.value)} placeholder="Worum geht es?" className="mt-2 min-h-11 w-full rounded-[14px] border border-line bg-page px-4 text-body text-ink placeholder:text-muted focus:border-ink focus:outline-none focus:ring-2 focus:ring-ink/10" />
      ...
      <textarea
        ...
        maxLength={4000}
        className="comment-field min-h-[110px] w-full flex-1 resize-none rounded-[14px] border border-line bg-page p-4 text-body text-ink placeholder:text-muted focus:border-ink focus:outline-none focus:ring-2 focus:ring-ink/10"
      />
