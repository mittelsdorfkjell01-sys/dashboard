...
def make_marine_response(days: int = 8) -> dict:
    ...
    return {
        ...
        "current": {
            ...
            "secondary_swell_wave_period": 13.0,
            "secondary_swell_wave_direction": 190.0,
            "sea_surface_temperature": 20.0,
        },
        "hourly": {
            "time": times,
            "wave_height": [1.4 + 0.1 * (i % 5) for i in range(n)],
            "wave_period": [8.0 + (i % 4) for i in range(n)],
            "wave_direction": [(240 + i) % 360 for i in range(n)],
            "wind_wave_height": [0.6 + 0.1 * (i % 3) for i in range(n)],
            "wind_wave_period": [3.5 + (i % 3) for i in range(n)],
            "wind_wave_direction": [(290 + i) % 360 for i in range(n)],
            ...
            "secondary_swell_wave_height": [0.3 + 0.1 * (i % 4) for i in range(n)],
            "secondary_swell_wave_period": [12.0 + (i % 5) for i in range(n)],
            "secondary_swell_wave_direction": [(180 + i) % 360 for i in range(n)],
